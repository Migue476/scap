...
<?php
$sel="SELECT `requests`.`id`, `ubicacion`, `nplacas`, `nombre`, `matricula`, `espacio`, `espacios_restantes`, `asistentes`, `fecha`, `horaentrada`, `horasalida` FROM `requests`,`parkings` WHERE `parkings`.`id`";
...
$espacio=$row['espacio'];
$espacios_restantes=$row['espacios_restantes'];
